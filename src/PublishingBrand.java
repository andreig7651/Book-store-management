        ...
        System.out.println("\t" + "<books>");
            for(Book mybook: books){
                System.out.println("\t" + "\t" + "<book>");
                    ...
                    System.out.print(mybook.createdOn.get(Calendar.DAY_OF_MONTH) + "." + mybook.createdOn.get(Calendar.MONTH) + "." 
                    + mybook.createdOn.get(Calendar.YEAR));
                    System.out.print(" " + mybook.createdOn.get(Calendar.HOUR_OF_DAY) + ":" + mybook.createdOn.get(Calendar.MINUTE) + ":" 
                    + mybook.createdOn.get(Calendar.SECOND));
